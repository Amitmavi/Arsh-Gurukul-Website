import "../Infrastructure/Transport.css";
  ...
  return (
    <div className="transport-page">
      ...
      <div className="transport-content">
        ...
        <p>
          First aid kit is available in buses.
        </p>
        <p>
          Child helpline number, woman helpline number, and emergency numbers are written in the buses.
        </p>
        <p>
          Fire extinguishers are installed in the buses.
        </p>
        <p>
          All vehicles comply with all safety measures and equipment suggested by Transport Department Haryana and District Administration.
        </p>
      </div>
    </div>
  );
